...
Controllers('EmailCtrl', ['$scope', '$user', '$dpd', '$location', function($scope, $user, $dpd, $location) {
	...
	$scope.confirmEmail = function() {
		...
		$dpd.users.put($scope.me.id, { email: $scope.email }, function(res, err) {
	...
	$user.getCurrent(function(me) {

		$scope.safeApply(function() {

			$scope.me = me;

			if(me.profile && me.profile.emails && me.profile.emails.length) {
				$scope.email = me.profile.emails[0].value;
			}

			else if(me.email && me.email.length) {
